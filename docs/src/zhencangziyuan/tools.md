...
https://www.jetbrains.com/idea/download/?var=1&section=windows
 <img src="/images/idea-install-1.png"  style="zoom: 50%;margin:0 auto;display:block"/><br/>
...
下载后的激活工具包目录如下：
 <img src="/images/idea-install-2.png"  style="zoom: 50%;margin:0 auto;display:block"/><br/>
...
> c、工具安装后，绝对不能移动或移除工具，否则后续IDEA打开会出现闪退，或提示找不到jar文件，“ja-netfilter.jar not found”
 ...
 <img src="/images/idea-install-3.png"  style="zoom: 50%;margin:0 auto;display:block"/><br/>
...
```
 <img src="/images/idea-install-4.png"  style="zoom: 50%;margin:0 auto;display:block"/><br/>
...
点击 Activate 按钮之后，激活成功!  
 <img src="/images/idea-install-5.png"  style="zoom: 50%;margin:0 auto;display:block"/><br/>
